...
public class OHRM_TCL_010 extends BaseTest {
	@Test(dataProvider="login9",dataProviderClass=ReadExcelData.class)
	public void valUserAllCapitalLetterPw(String user,String pw) throws InterruptedException {
		...
		test.log(LogStatus.PASS,"valUserAllCapitalLetterPw Test is passed");
	}
}
