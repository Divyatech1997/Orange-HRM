...
public class OHRM_TCL_026 extends BaseTest {
	@Test(dataProvider="login26",dataProviderClass=ReadPropertiesFile.class)
	public void minimumCharInUsername(String user,String pw) throws InterruptedException {
		...
		test.log(LogStatus.PASS,"minimumCharInUsername Test is passed");
}
