...
public class OHRM_TCL_011 extends BaseTest {
	@Test(dataProvider="login10",dataProviderClass=ReadExcelData.class)
	public void ValUserFirstLetterPwLorUCase(String user,String pw) throws InterruptedException {
		...
		test.log(LogStatus.PASS,"ValUserFirstLetterPwLorUCase Test is passed");
	}
}
