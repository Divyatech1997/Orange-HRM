...
public class OHRM_TCL_029 extends BaseTest {
	@Test(dataProvider="login29",dataProviderClass=ReadPropertiesFile.class)
	public void verifyMaxCharPw(String user,String pw) throws InterruptedException {
		...
		test.log(LogStatus.PASS,"verifyMaxCharPw Test is passed");
}
