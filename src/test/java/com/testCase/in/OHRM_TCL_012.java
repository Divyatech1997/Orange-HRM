...
public class OHRM_TCL_012 extends BaseTest {
	@Test(dataProvider="login11",dataProviderClass=ReadExcelData.class)
	public void FirstLetterUserLorUCaseValPw(String user,String pw) throws InterruptedException {
		...
		test.log(LogStatus.PASS,"FirstLetterUserLorUCaseValPw Test is passed");
	}
}
