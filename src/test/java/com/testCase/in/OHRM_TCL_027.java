...
public class OHRM_TCL_027 extends BaseTest {
		@Test(dataProvider="login27",dataProviderClass=ReadPropertiesFile.class)
		public void verifyMinCharPw(String user,String pw) throws InterruptedException {
			...
			test.log(LogStatus.PASS,"verifyMinCharPw Test is passed");
}
